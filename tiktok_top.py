...
time.sleep(2)
el6 = driver.find_element(by=AppiumBy.ID, value="com.ss.android.ugc.trill:id/d55")
el6.click()
time.sleep(1)
el7 = driver.find_element(by=AppiumBy.ID, value="com.ss.android.ugc.trill:id/bx_")
el7.send_keys(f"{CATEGORY}")
time.sleep(2)
el8 = driver.find_element(by=AppiumBy.ID, value="com.ss.android.ugc.trill:id/iwv")
el8.click()
time.sleep(2)
...
def get_link():
    #driver.implicitly_wait(4)
    time.sleep(2)
    driver.find_element(by=AppiumBy.ID, value="com.ss.android.ugc.trill:id/h0a").click()
    #driver.implicitly_wait(4)
    time.sleep(2)
